const translations = {
  no: {
    ...
    // Onboarding
    "onboarding.step1Title": "Velkommen til CueFilm",
    "onboarding.step1Body": "Vi hjelper deg å finne den perfekte filmen basert på humøret ditt — ikke bare sjanger.",
    "onboarding.step2Title": "Slik fungerer det",
    "onboarding.step2Body": "Velg hvordan du føler deg nå, og hvordan du vil føle deg. Vi finner filmer som tar deg dit.",
    "onboarding.step3Title": "Klar til å se?",
    "onboarding.step3Body": "Lagre favoritter, del med venner, og la oss lære hva du liker over tid.",
    "onboarding.next": "Neste",
    "onboarding.back": "Tilbake",
    "onboarding.skip": "Hopp over",
    "onboarding.start": "La oss begynne!",

    // Search history
    "history.tab": "Tidligere søk",
    "history.title": "Tidligere søk",
    "history.noMood": "Ingen humør valgt",
    "history.random": "Tilfeldig",
    "history.gem": "Skjult perle",
    "history.showMore": "Vis {count} flere",
    "history.showLess": "Vis færre",
    "history.empty": "Ingen søk ennå",
    "history.emptyHint": "Søkehistorikken din vises her etter ditt første søk.",

    // Watch together
    "room.title": "Se sammen",
    "room.subtitle": "Finn filmer alle i gruppen vil like.",
    "room.createBtn": "Opprett rom",
    "room.joinBtn": "Bli med",
    "room.createTitle": "Opprett et rom",
    "room.joinTitle": "Bli med i et rom",
    "room.nameLabel": "Ditt navn",
    "room.namePlaceholder": "Skriv navnet ditt...",
    "room.codeLabel": "Romkode",
    "room.lobbyTitle": "Venter på deltakere...",
    "room.copy": "Kopier",
    "room.shareHint": "Del koden med vennene dine så de kan bli med.",
    "room.participants": "Deltakere",
    "room.findMovies": "Finn filmer for alle!",
    "room.errorCreate": "Kunne ikke opprette rom. Prøv igjen.",
    "room.errorJoin": "Kunne ikke bli med. Sjekk koden og prøv igjen.",
    "room.errorGeneric": "Noe gikk galt. Prøv igjen.",
    "room.button": "Se sammen",

    // Taste / sharing
    "taste.myTaste": "Min filmsmak",
    "taste.genres": "Favorittsjangre",
    "taste.director": "Favorittregissør",
    "taste.decade": "Favoritttiår",
    "taste.movies": "Filmer",
    "taste.liked": "Likt",
    "taste.watched": "Sett",
    "taste.topGenres": "Topp sjangre",
    "taste.favDirector": "Favorittregissør",
    "taste.favDecade": "Favoritttiår",
    "taste.shareBtn": "Del min filmsmak",
    "taste.cta": "Finn din filmsmak på CueFilm!",
    "taste.button": "Min filmsmak",

    // Push notifications
    "push.enable": "Slå på varsler",
    "push.enabled": "Varsler er på",
    "push.description": "Få varsler om nye filmer som passer deg.",
  ...
  "privacy.back": "← Tilbake til CueFilm",
  "privacy.lastUpdated": "Sist oppdatert: april 2026",
  "privacy.introTitle": "Innledning",
  "privacy.introText": "CueFilm er en filmanbefalingstjeneste som hjelper deg med å finne filmer og serier basert på humøret ditt. Vi tar personvernet ditt på alvor og behandler data i henhold til GDPR og norsk personvernlovgivning.",
  "privacy.dataTitle": "Hvilke data samler vi inn?",
  "privacy.dataIntro": "Når du oppretter en konto og bruker CueFilm, lagrer vi følgende:",
  "privacy.dataAuth": "Kontoinformasjon: Navn, e-postadresse og profilbilde fra innloggingstjenesten (Clerk/Google).",
  "privacy.dataLibrary": "Filmbibliotek: Filmer du lagrer, markerer som sett, eller liker/misliker.",
  "privacy.dataHistory": "Søkehistorikk: Humør, filtre og resultater fra dine søk.",
  "privacy.dataSettings": "Innstillinger: Tema, språk, og profil-preferanser.",
  "privacy.purposeTitle": "Hvorfor samler vi inn data?",
  "privacy.purposeRecommendations": "Gi deg personlige filmanbefalinger basert på humør og preferanser.",
  "privacy.purposePersonalization": "Forbedre anbefalinger over tid basert på filmene du liker.",
  "privacy.purposeSync": "Synkronisere filmbiblioteket ditt på tvers av enheter.",
  "privacy.thirdPartyTitle": "Tredjeparter",
  "privacy.thirdPartyClerk": "Håndterer innlogging og autentisering. Lagrer kontoinformasjon.",
  "privacy.thirdPartyTmdb": "Leverer filmdata (plakater, beskrivelser, rating). Ingen persondata deles.",
  "privacy.thirdPartyOpenRouter": "Genererer AI-forklaringer for filmanbefalinger. Ingen persondata deles.",
  "privacy.thirdPartyMongo": "Databasetjeneste der brukerdata lagres kryptert.",
  "privacy.cookiesTitle": "Informasjonskapsler (cookies)",
  "privacy.cookiesText": "CueFilm bruker nødvendige informasjonskapsler for innlogging via Clerk. Vi bruker ikke sporings- eller reklamecookies.",
  "privacy.rightsTitle": "Dine rettigheter",
  "privacy.rightsIntro": "Som bruker har du rett til å:",
  "privacy.rightsAccess": "Få innsyn i hvilke data vi har lagret om deg.",
  "privacy.rightsDelete": "Slette kontoen din og alle tilhørende data (via Innstillinger > Konto).",
  "privacy.rightsExport": "Be om eksport av dataene dine.",
  "privacy.rightsWithdraw": "Trekke tilbake samtykke når som helst.",
  "privacy.rightsHow": "For å utøve rettighetene dine kan du slette kontoen din direkte i appen under Innstillinger, eller kontakte oss.",
  "privacy.contactTitle": "Kontakt",
  "privacy.contactText": "Har du spørsmål om personvern? Kontakt oss på e-post: privacy@cuefilm.no",
  "privacy.linkLabel": "Personvernerklæring",
  ...
  en: {
    ...
    // Onboarding
    "onboarding.step1Title": "Welcome to CueFilm",
    "onboarding.step1Body": "We help you find the perfect movie based on your mood — not just genre.",
    "onboarding.step2Title": "How it works",
    "onboarding.step2Body": "Pick how you feel now, and how you want to feel. We find movies that take you there.",
    "onboarding.step3Title": "Ready to watch?",
    "onboarding.step3Body": "Save favorites, share with friends, and let us learn what you like over time.",
    ...
    // Search history
    "history.tab": "Recent searches",
    "history.title": "Recent searches",
    "history.noMood": "No mood selected",
    "history.random": "Random",
    "history.gem": "Hidden gem",
    "history.showMore": "Show {count} more",
    "history.showLess": "Show less",
    "history.empty": "No searches yet",
    "history.emptyHint": "Your search history will appear here after your first search.",

    // Watch together
    "room.title": "Watch together",
    "room.subtitle": "Find movies everyone in the group will enjoy.",
    "room.createBtn": "Create room",
    "room.joinBtn": "Join room",
    "room.createTitle": "Create a room",
    "room.joinTitle": "Join a room",
    "room.nameLabel": "Your name",
    "room.namePlaceholder": "Enter your name...",
    "room.codeLabel": "Room code",
    "room.lobbyTitle": "Waiting for participants...",
    "room.copy": "Copy",
    "room.shareHint": "Share the code with your friends so they can join.",
    "room.participants": "Participants",
    "room.findMovies": "Find movies for everyone!",
    "room.errorCreate": "Could not create room. Try again.",
    "room.errorJoin": "Could not join. Check the code and try again.",
    "room.errorGeneric": "Something went wrong. Try again.",
    "room.button": "Watch together",

    // Taste / sharing
    "taste.myTaste": "My film taste",
    "taste.genres": "Favorite genres",
    "taste.director": "Favorite director",
    "taste.decade": "Favorite decade",
    "taste.movies": "Movies",
    "taste.liked": "Liked",
    "taste.watched": "Watched",
    "taste.topGenres": "Top genres",
    "taste.favDirector": "Favorite director",
    "taste.favDecade": "Favorite decade",
    "taste.shareBtn": "Share my film taste",
    "taste.cta": "Find your film taste on CueFilm!",
    "taste.button": "My film taste",

    // Push notifications
    "push.enable": "Enable notifications",
    "push.enabled": "Notifications on",
    "push.description": "Get notified about new movies that match your taste.",
    ...
    "privacy.back": "← Back to CueFilm",
    "privacy.lastUpdated": "Last updated: April 2026",
    "privacy.introTitle": "Introduction",
    "privacy.introText": "CueFilm is a movie recommendation service that helps you find movies and series based on your mood. We take your privacy seriously and process data in accordance with GDPR.",
    "privacy.dataTitle": "What data do we collect?",
    "privacy.dataIntro": "When you create an account and use CueFilm, we store the following:",
    "privacy.dataAuth": "Account information: Name, email address, and profile picture from your sign-in provider (Clerk/Google).",
    "privacy.dataLibrary": "Movie library: Movies you save, mark as watched, or like/dislike.",
    "privacy.dataHistory": "Search history: Mood, filters, and results from your searches.",
    "privacy.dataSettings": "Settings: Theme, language, and profile preferences.",
    "privacy.purposeTitle": "Why do we collect data?",
    "privacy.purposeRecommendations": "Provide personalized movie recommendations based on mood and preferences.",
    "privacy.purposePersonalization": "Improve recommendations over time based on the movies you like.",
    "privacy.purposeSync": "Sync your movie library across devices.",
    "privacy.thirdPartyTitle": "Third parties",
    "privacy.thirdPartyClerk": "Handles sign-in and authentication. Stores account information.",
    "privacy.thirdPartyTmdb": "Provides movie data (posters, descriptions, ratings). No personal data is shared.",
    "privacy.thirdPartyOpenRouter": "Generates AI explanations for movie recommendations. No personal data is shared.",
    "privacy.thirdPartyMongo": "Database service where user data is stored encrypted.",
    ...
    "privacy.rightsIntro": "As a user, you have the right to:",
    "privacy.rightsAccess": "Access the data we have stored about you.",
    "privacy.rightsDelete": "Delete your account and all associated data (via Settings > Account).",
    "privacy.rightsExport": "Request an export of your data.",
    "privacy.rightsWithdraw": "Withdraw your consent at any time.",
    "privacy.rightsHow": "To exercise your rights, you can delete your account directly in the app under Settings, or contact us.",
    "privacy.contactTitle": "Contact",
    "privacy.contactText": "Questions about privacy? Contact us at: privacy@cuefilm.no",
